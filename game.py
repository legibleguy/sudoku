...
#board from homework, board (a)
testBoard.set_value_at(0, 2, 1)
testBoard.set_value_at(0, 5, 2)
testBoard.set_value_at(1, 2, 5)
testBoard.set_value_at(1, 5, 6)
testBoard.set_value_at(1, 7, 3)
testBoard.set_value_at(2, 0, 4)
testBoard.set_value_at(2, 1, 6)
testBoard.set_value_at(2, 5, 5)

testBoard.set_value_at(3, 3, 1)
testBoard.set_value_at(3, 5, 4)
testBoard.set_value_at(4, 0, 6)
testBoard.set_value_at(4, 3, 8)
testBoard.set_value_at(4, 6, 1)
testBoard.set_value_at(4, 7, 4)
testBoard.set_value_at(4, 8, 3)
testBoard.set_value_at(5, 4, 9)
testBoard.set_value_at(5, 6, 5)
testBoard.set_value_at(5, 8, 8)

testBoard.set_value_at(6, 0, 8)
testBoard.set_value_at(6, 4, 4)
testBoard.set_value_at(6, 5, 9)
testBoard.set_value_at(6, 7, 5)
testBoard.set_value_at(7, 0, 1)
testBoard.set_value_at(7, 3, 3)
testBoard.set_value_at(7, 4, 2)
testBoard.set_value_at(8, 2, 9)
testBoard.set_value_at(8, 6, 3)
